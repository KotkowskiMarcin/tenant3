...
export default function SettlementCreateModal({ isOpen, onClose, rental, meters, years, months }) {
    ...
    // Generuj domyślne składniki przy otwieraniu modalu
    useEffect(() => {
        if (isOpen && rental) {
            clearErrors();
            reset();
        ...
        if (meters && meters.length > 0) {
            meters.forEach(meter => {
                defaultComponents.push({
                    ...
                    previous_reading: meter.current_reading || 0,
                    current_reading: meter.current_reading || 0,
                    consumption: 0,
                });
            });
        }
                ...
                <div className="mt-3">
                    ...
                    <div className="flex items-center justify-between pb-4 border-b">
                        <h3 className="text-lg font-medium text-gray-900">
                            Generuj nowe rozliczenie miesięczne
                        </h3>
                        <button
                            onClick={onClose}
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    ...
                                    <div>
                                        ...
                                        <select
                                            ...
                                            className="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm"
                                        >
                                            {months && Object.entries(months).map(([value, label]) => (
