...
export default function SettlementEditModal({ isOpen, onClose, rental, settlement, meters }) {
    ...
    // Inicjalizuj dane z istniejącego rozliczenia
    useEffect(() => {
        if (isOpen && settlement) {
            clearErrors();
            reset();
            
            const settlementComponents = settlement.components || [];
            setComponents(settlementComponents);
    ...
    // Ustaw domyślnie zwinięte składniki po załadowaniu
    useEffect(() => {
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        patch(route('rentals.monthly-settlements.update', [rental.id, settlement.id]), {
            onSuccess: () => {
                onClose();
    ...
    // Sprawdź, czy rozliczenie jest opłacone
                            ...
                            <div className="mt-3">
                                ...
                                <div className="mt-2">
                                    <p className="text-sm text-gray-500">
                                        Nie można edytować rozliczenia, które zostało już opłacone.
                                    </p>
                                </div>
                            </div>
                            <div className="mt-6">
