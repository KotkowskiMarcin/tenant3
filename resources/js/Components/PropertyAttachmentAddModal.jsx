...
export default function PropertyAttachmentAddModal({ 
    isOpen, 
    onClose, 
    property 
}) {
                            ...
                            <DialogPanel className="relative transform overflow-hidden rounded-lg bg-white px-4 pb-4 pt-5 text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-2xl sm:p-6">
                                ...
                                <div className="sm:flex sm:items-start">
                                    <div className="mt-3 text-center sm:ml-4 sm:mt-0 sm:text-left w-full">
                                        <DialogTitle as="h3" className="text-lg font-semibold leading-6 text-gray-900 mb-6 flex items-center">
                                        ...
                                        <form onSubmit={handleSubmit} className="space-y-4">
                                            ...
                                            {data.attachments && data.attachments.length > 0 && (
                                                <div className="space-y-3">
                                                    <h5 className="text-sm font-medium text-gray-700">Podgląd plików</h5>
