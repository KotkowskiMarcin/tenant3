...
export default function Index({ property, rentals }) {
    ...
    return (
        <AuthenticatedLayout>
            <Head title={`Najmy - ${property.name}`} />
                    ...
                    <div className="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                        <div className="p-6 text-gray-900">
                            <div className="flex justify-between items-center mb-6">
                                ...
                                <Link
                                    href={route('properties.rentals.create', property.id)}
                            ...
                            {rentals.data.length === 0 ? (
                                <div className="text-center py-12">
                                    <p className="text-gray-500 text-lg">Brak najmów dla tej nieruchomości.</p>
                                    <Link
                                        href={route('properties.rentals.create', property.id)}
