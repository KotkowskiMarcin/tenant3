...
export default function Edit({ rental, settlement, meters, years, months }) {
    const [components, setComponents] = useState(settlement.components || []);
    const [selectedYear, setSelectedYear] = useState(settlement.year);
    const [selectedMonth, setSelectedMonth] = useState(settlement.month);
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        put(route('rentals.monthly-settlements.update', [rental.id, settlement.id]));
    };

    return (
        <AuthenticatedLayout>
            <Head title="Edytuj rozliczenie" />
                                ...
                                <div className="flex items-center">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-sm text-gray-500">
                                            Okres: {settlement.formatted_date}
                                        </p>
                                    </div>
                                </div>
                            </div>
